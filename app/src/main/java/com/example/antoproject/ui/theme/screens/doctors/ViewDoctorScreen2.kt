...
@Composable
fun ViewDoctorScreen2(navController: NavController) {
...
@Composable
fun DoctorItem2(name:String, phone:String, id:String,
               navController: NavController,
...
fun ViewDoctorScreen2Preview(){

    ViewDoctorScreen2(navController = rememberNavController())
